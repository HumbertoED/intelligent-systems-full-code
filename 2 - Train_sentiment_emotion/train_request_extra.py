...
with open('data_sentiment_analysis.csv', 'wb') as csvfile:
    ...
    for z in range(0, 3000):
        writer.writerow({'Tweet': array[z], 'Class': array2[z], 'Polarity':array3[z], 'Agreement':array4[z], 'Subjectivity':array5[z], 'Confidence':array6[z], 'Irony':array7[z], 'Anger': array8[z], 'Joy': array9[z], 'Fear': array10[z], 'Sadness': array11[z], 'Surprise': array12[z]})
