...
with open('data_train_analysis.csv', 'wb') as csvfile:
    fieldnames = ['Tweet', 'Class', 'Polarity', 'Agreement', 'Subjectivity', 'Confidence', 'Irony', 'Anger', 'Joy', 'Fear', 'Sadness', 'Surprise', 'Extraversion', 'Openness', 'Agreeableness', 'Conscientiousness']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)

    writer.writeheader()
    for z in range(0, 3000):
        writer.writerow({'Tweet': array[z], 'Class': array2[z], 'Polarity':array3[z], 'Agreement':array4[z], 'Subjectivity':array5[z], 'Confidence':array6[z], 'Irony':array7[z], 'Anger': array8[z], 'Joy': array9[z], 'Fear': array10[z], 'Sadness': array11[z], 'Surprise': array12[z], 'Extraversion': extraversion_array[z], 'Openness': openness_array[z], 'Agreeableness': agreeableness_array[z], 'Conscientiousness': conscientiousness_array[z]})
