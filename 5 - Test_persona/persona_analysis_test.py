...
with open('test_original.csv', 'rb') as File:
...
with open('personas_test_analysis.csv', 'wb') as csvfile:
    fieldnames = ['Tweet', 'Id', 'Advocate', 'Debator', 'Mediator', 'Consul']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)

    writer.writeheader()
    for z in range(0, 1500):
        writer.writerow({'Tweet': array[z], 'Id': array2[z], 'Advocate': advocate_array[z], 'Debator': debator_array[z], 'Mediator': mediator_array[z], 'Consul': consul_array[z]})
